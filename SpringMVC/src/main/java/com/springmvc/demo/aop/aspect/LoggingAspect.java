...
import com.springmvc.demo.aop.main.Account;
...
public class LoggingAspect {
	...
	@Around("execution(* com.springmvc.demo.aop.service.TrafficFortuneService.getFortune(..))")
	...
	@After("execution(* com.springmvc.demo.aop.dao.AccountDAO.findAccounts(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.springmvc.demo.aop.dao.AccountDAO.findAccounts(..))", throwing = "theExc")
	...
	@AfterReturning(pointcut = "execution(* com.springmvc.demo.aop.dao.AccountDAO.findAccounts(..))", returning = "result")
